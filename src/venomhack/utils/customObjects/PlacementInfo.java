...
public class PlacementInfo {
   ...
   public float value(LivingEntity lastPlacetarget) {
      return this.damage * (float)(this.target != null && this.target.equals(lastPlacetarget) ? 2 : 1)
         - this.selfDamage
         + (float)(this.pops * 1000)
         - (float)(this.selfPop ? 10000 : 0)
         - this.friendDamage
         - (float)(this.friendPops * 100);
   }
}
